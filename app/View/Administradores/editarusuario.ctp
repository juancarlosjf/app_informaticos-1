<div class="row-fluid">
	<div class=" widget">
		<div class="widget-header">
			<span class="title">Edición de Usuarios</span>
				</div>
				<div class="widget-content form-container">
				<?php echo $this->Form->create('Usuario',array('url'=>'/Administradores/editarusuario/'.$this->request->data['Usuario']['id'].'','class'=>'form-vertical'));?>
				<?php
					echo '<div class="control-group">'.$this->Form->input('full_nombre',array('label' => array('class' => 'control-label', 'text' => 'Nombre completo'),'required','div'=>'control-group','between'=>'<div class="controls">','after'=>'</div>')).'</div>'; 
					...
					echo $this->Form->button('Actualizar',array('type'=>'submit','class'=>'btn btn-danger btn-block btn-large'));	
					echo $this->Form->end(); 
				?>
				</div>
	</div>
